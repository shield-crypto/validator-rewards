...
echo "TYPE shield_stake gauge \n" >> $METRIC_FILE
echo "shield_stake $STAKE  \n" >> $METRIC_FILE

echo "HELP shield_rewards rewards generated by the validator \n" >> $METRIC_FILE
echo "TYPE shield_rewards gauge \n" >> $METRIC_FILE
echo "shield_rewards $COMMISSION  \n" >> $METRIC_FILE
